...
urlpatterns = [
     ...
     path('Ver-Plantin/<int:pk>/', FrutalDetailView.as_view(), name='verplantin'),
     path('Edita-Plantin/<int:pk>/', FrutalUpdateView.as_view(), name='editplantin'),
     path('Elimina-Plantin/<int:pk>/', FrutalDeleteView.as_view(), name='eliminaplantin'),
